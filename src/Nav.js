        ...
        <div className={`bg-slate-200 z-50 fixed top-0 ${isActive ? "left-0" : "-left-[130%]"} bottom-0 w-[70vw] lg:left-0 lg:relative lg:w-[100%] transition-all duration-500 ease-in-out`}>
            ...
            <div className="menu-list">
                <div className="menu pl-[3rem] p-3 hover:pl-[4.5rem] transition-all duration-700 ease-in-out cursor-pointer border-l-[.3rem] text-gray-900 border-gray-800">
                    <h3 className='flex gap-6 items-center text-[1rem] md:text-[1.3rem]'><AiFillHome /> Overview</h3>
                </div>
                <div className="menu pl-[3rem] p-3 text-slate-600 hover:pl-[4.5rem] transition-all duration-700 ease-in-out cursor-pointer">
                    <h3 className='flex gap-6 items-center text-[1rem] md:text-[1.3rem]'><TiArrowBack /> Revenue</h3>
                </div>
                <div className="menu pl-[3rem] p-3 text-slate-600 hover:pl-[4.5rem] transition-all duration-700 ease-in-out cursor-pointer">
                    <h3 className='flex gap-6 items-center text-[1rem] md:text-[1.3rem]'><TbArrowsRightLeft /> Costs</h3>
                </div>
                <div className="menu pl-[3rem] p-3 text-slate-600 hover:pl-[4.5rem] transition-all duration-700 ease-in-out cursor-pointer">
                    <h3 className='flex gap-6 items-center text-[1rem] md:text-[1.3rem]'><RiWalletFill /> Services</h3>
                </div>
                <div className="menu pl-[3rem] p-3 text-slate-600 hover:pl-[4.5rem] transition-all duration-700 ease-in-out cursor-pointer">
                    <h3 className='flex gap-6 items-center text-[1rem] md:text-[1.3rem]'><FaChartLine /> New Sales</h3>
                </div>
                <div className="menu pl-[3rem] p-3 text-slate-600 hover:pl-[4.5rem] transition-all duration-700 ease-in-out cursor-pointer">
                    <h3 className='flex gap-6 items-center text-[1rem] md:text-[1.3rem]'><IoIosNotifications /> Notifications</h3>
                </div>
